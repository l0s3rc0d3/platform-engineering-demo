module "vpc" {
  ...
  private_subnets = concat(var.vpc_private_subnets, var.vpc_eks_pods_subnets)
  ...
  # This is a demo so a single nat gateway is enough (cause underneath the natgateway is a secret ec2 instance)
